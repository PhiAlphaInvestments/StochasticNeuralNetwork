//+------------------------------------------------------------------+
//|                                                NeuralNetworkStoActivation.mqh |
//|                                                 William Nicholas |
//|                                             https://www.mql5.com |
//+------------------------------------------------------------------+
...
class NeuralNetworkStoActivation{
      ...
      public:
         ...
         NeuralNetworkStoActivation(int in_DimensionRow,int in_DimensionCol,int Number_of_Neurons,int out_Dimension,double alpha,double LearningRate,bool Verbose,double beta_1, double beta_2,int max_iterations,double Sto_a_Min,double Sto_a_Max);
...
bool NeuralNetworkStoActivation::LoadWeights(void){
...
bool NeuralNetworkStoActivation::WriteWeights(void){
...
void NeuralNetworkStoActivation::ResetWeights(void){
...
void NeuralNetworkStoActivation::ComputeDerivatives(matrix &Input , matrix &y_){
...
NeuralNetworkStoActivation::NeuralNetworkStoActivation(int in_DimensionRow,int in_DimensionCol,int Number_of_Neurons,int out_Dimension,double alpha,double LearningRate,bool Verbose,double beta_1, double beta_2,int max_iterations,double Sto_a_Min,double Sto_a_Max) {
...
matrix NeuralNetworkStoActivation::Prediction(matrix& Input){
...
void NeuralNetworkStoActivation::Train(matrix &Input,matrix &correct_Val){
...
double NeuralNetworkStoActivation::Cost(matrix &Input , matrix &y_){
...
matrix NeuralNetworkStoActivation::Forward_Prop(matrix& Input){
...
double NeuralNetworkStoActivation::Sigmoid(double x) {
       int error;
...
double NeuralNetworkStoActivation::Sigmoid_Prime(double x){
      int error; 
       double a = MathRandomUniform(m_Sto_Range_a_Min,m_Sto_Range_a_Max,error);
...
int NeuralNetworkStoActivation::Sgn(double Value){
...
void NeuralNetworkStoActivation::MatrixRandom(matrix& m)
 {
   int error;
...
matrix NeuralNetworkStoActivation::MatrixSigmoid(matrix& m)
 {
  matrix m_2;
...
matrix NeuralNetworkStoActivation::MatrixSigmoidPrime(matrix& m)
{
  matrix m_2;
  m_2.Init(m.Rows(),m.Cols());
  for(ulong r=0; r<m.Rows(); r++)
